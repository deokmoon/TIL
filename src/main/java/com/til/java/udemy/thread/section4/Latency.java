...
public class Latency {
    public static final String SOURCE_FILE = "./resources/many-flowers.pnf";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // compare two solutions: performance/latency measurement
        long startTime = System.currentTimeMillis();
        // single
        recolorSingleThreaded(originalImage, resultImage); // single
    ...
    //break the image and run it into multiple threads
